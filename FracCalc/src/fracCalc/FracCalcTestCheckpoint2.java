...
public class FracCalcTestCheckpoint2
{
    ...
    { 
    	...
    	//Checkpoint2
    	int numeratorPosition = secondFraction.indexOf("_");
		int denominatorPosition = secondFraction.indexOf("/");
		
		String whole;
		String numerator;
		String denominator;
		
		if(numeratorPosition < 0 && denominatorPosition < 0){
			whole  = secondFraction.substring(1);
			numerator = "0";
			denominator = "1";
		}else if(denominatorPosition >= 0 && numeratorPosition <= 0){
			numerator = secondFraction.substring(1, denominatorPosition);
			denominator = secondFraction.substring(denominatorPosition+1);
			whole = "0";
		}else{
			whole = secondFraction.substring(1, numeratorPosition);
			numerator = secondFraction.substring(numeratorPosition+1, denominatorPosition);
			denominator = secondFraction.substring(denominatorPosition+1); 
		}
